/* src/config/zuzcoin-config.h.  Generated from zuzcoin-config.h.in by configure.  */
/* src/config/zuzcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Zuzcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Zuzcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/zuzcoin/zuzcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Zuzcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Zuzcoin Core 0.16.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zuzcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://zuzcoincore.org/"

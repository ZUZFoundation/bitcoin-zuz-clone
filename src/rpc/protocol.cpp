...
static const char *httpStatusDescription(int nStatus)
{
    ...
    case HTTP_UNAUTHORIZED: return "Not Authorized";
    case HTTP_BAD_METHOD: return "Bad Method";
...
/**
 * JSON-RPC protocol.  Zuzcoin speaks version 1.0 for maximum compatibility,

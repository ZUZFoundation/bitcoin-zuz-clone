...
BOOST_AUTO_TEST_CASE(bloom_match)
{
    ...
    CDataStream spendStream(vch, SER_DISK, CLIENT_VERSION | SERIALIZE_BITCOIN_BLOCK_OR_TX);
...
BOOST_AUTO_TEST_CASE(merkle_block_3_and_serialize)
{
    ...
    CDataStream merkleStream(SER_NETWORK, PROTOCOL_VERSION | SERIALIZE_BITCOIN_BLOCK_OR_TX);

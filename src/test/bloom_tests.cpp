...
=======
    mtx.vin.resize(1);
    mtx.vin[0].prevout.hash = uint256("90c122d70786e899529d71dbeba91ba216982fb6ba58f3bdaab65e73b7e9260b");
...
>>>>>>> elements/alpha
    ...
    uint256 tx_revtxid = uint256(tx_txid.ToString());
...
=======
    ...
    block.nVersion = 1;
    block.hashPrevBlock = uint256("00000000000080b66c911bd5ba14a74260057311eaeb1982802f7010f1a9f090");
    ...
    mtx.vin.resize(1);
    mtx.vin[0].prevout.hash = uint256("36e8f98c5f5733f88ca00dfa05afd7af5dc34dda802790daba6aa1afcb8c6096");
    mtx.vin[0].prevout.n = 0;
    ...
    mtx.vin.resize(1);
    mtx.vin[0].prevout.hash = uint256("6db5acbf1994c2e3c4f78a6bde06c78ed9248be481eccfaf2b8c4588126c76fb");
    mtx.vin[0].prevout.n = 0;
    ...
    mtx.vin.resize(2);
    mtx.vin[0].prevout.hash = uint256("fff2525b8931402dd09222c50775608f75787bd2b87e56995a7bdd30f79702c4");
    ...
    mtx.vin[0].scriptSig = CScript(vchScript.begin(), vchScript.end());
    mtx.vin[1].prevout.hash = uint256("fbde5d03b027d2b9ba4cf5d4fecab9a99864df2637b25ea4cbcb1796ff6550ca");
    ...
    mtx.vin.resize(1);
    mtx.vin[0].prevout.hash = uint256("fac2d53ed2f083c8dba090aaf88949c8e4d13306c52d5e6514c5918e752fafcd");
    mtx.vin[0].prevout.n = 1;
    ...
    mtx.vin.resize(1);
    mtx.vin[0].prevout.hash = uint256("cb00f8a0573b18faa8c4f467b049f5d202bf1101d9ef2633bc611be70376a4b4");
    mtx.vin[0].prevout.n = 1;
    ...
    mtx.vin.resize(5);
    mtx.vin[0].prevout.hash = uint256("9eb4ab14fb5480539ae42f02f9765170e04d203e4ab1ed60bb19d202d62cc686");
    mtx.vin[0].prevout.n = 1;
    ...
    mtx.vin[0].scriptSig = CScript(vchScript.begin(), vchScript.end());
    mtx.vin[1].prevout.hash = uint256("79217b4483ae283a4baafa0633a9b097196fcf8b218ac29ddfc3dacc580ead03");
    ...
    mtx.vin[1].scriptSig = CScript(vchScript.begin(), vchScript.end());
    mtx.vin[2].prevout.hash = uint256("7b109e08956a7171d253f54a14ba30005821c9623760925768c8bb29b6cacf2a");
    ...
    mtx.vin[3].prevout.hash = uint256("d2fc17c534865a3b114fd23c0adf7d73cbea618e58dc8d654a94c9bb2360dcdc");
    ...
    mtx.vin[4].prevout.hash = uint256("6ec73ab8069fd68f034afafc215bedd7f6ed1465dcd6df79f458e25ccd5755e1");
    ...
    mtx.vin.resize(1);
    mtx.vin[0].prevout.hash = uint256("8ded96ae2a609555df2390faa2f001b04e6e0ba8a60c69f9b432c9637157d766");
    mtx.vin[0].prevout.n = 0;
    ...
    mtx.vin.resize(1);
    mtx.vin[0].prevout.hash = uint256("71b3dbaca67e9f9189dad3617138c19725ab541ef0b49c05a94913e9f28e3f4e");
    mtx.vin[0].prevout.n = 1;
...
BOOST_AUTO_TEST_CASE(merkle_block_2)
{
    ...
    block.nVersion = 1;
    block.hashPrevBlock = uint256("00000000689051c09ff2cd091cc4c22c10b965eb8db3ad5f032621cc36626175");
    ...
    mtx.vin.resize(2);
    mtx.vin[0].prevout.hash = uint256("35288d269cee1941eaebb2ea85e32b42cdb2b04284a56d8b14dcc3f5c65d6055");
    mtx.vin[0].prevout.n = 0;
    ...
    mtx.vin[0].scriptSig = CScript(vchScript.begin(), vchScript.end());
    mtx.vin[1].prevout.hash = uint256("35288d269cee1941eaebb2ea85e32b42cdb2b04284a56d8b14dcc3f5c65d6055");
    mtx.vin[1].prevout.n = 1;
    ...
    mtx.vin.resize(2);
    mtx.vin[0].prevout.hash = uint256("6b0f8a73a56c04b519f1883e8aafda643ba61a30bd1439969df21bea5f4e27e2");
    mtx.vin[0].prevout.n = 0;
    ...
    mtx.vin[0].scriptSig = CScript(vchScript.begin(), vchScript.end());
    mtx.vin[1].prevout.hash = uint256("6b0f8a73a56c04b519f1883e8aafda643ba61a30bd1439969df21bea5f4e27e2");
    mtx.vin[1].prevout.n = 1;
...
BOOST_AUTO_TEST_CASE(merkle_block_3_and_serialize)
{
    ...
    block.nVersion = 1;
    block.hashPrevBlock = uint256("000000000000b0b8b4e8105d62300d63c8ec1a1df0af1c2cdbd943b156a8cd79");
...
BOOST_AUTO_TEST_CASE(merkle_block_4)
{
    ...
    block.nVersion = 1;
    block.hashPrevBlock = uint256("0000000000016780c81d42b7eff86974c36f5ae026e8662a4393a7f39c86bb82");
    ...
    mtx.vin.resize(1);
    mtx.vin[0].prevout.hash = uint256("437248e07f73b031bba6aacde3e9f3f70b12559298084f42d12798a2a620adbc");
    mtx.vin[0].prevout.n = 0;
    ...
    mtx.vin.resize(3);
    mtx.vin[0].prevout.hash = uint256("0bcb16af267dee77ed8761662d31ee9d9a1bf1e4d268a9e7127407ebb3f9acfd");
    mtx.vin[0].prevout.n = 0;
    ...
    mtx.vin[0].scriptSig = CScript(vchScript.begin(), vchScript.end());
    mtx.vin[1].prevout.hash = uint256("83afb597f39d42753e3a97b897b471f02d0be7963ef8c4f350cb4e6313199e30");
    mtx.vin[1].prevout.n = 0;
    ...
    mtx.vin[1].scriptSig = CScript(vchScript.begin(), vchScript.end());
    mtx.vin[2].prevout.hash = uint256("c1e6b1bc0c0e1b2bce13df72d3b6b54d837d8f428ac1edc98050699134e38920");
    ...
    mtx.vin.resize(4);
    mtx.vin[0].prevout.hash = uint256("4734748106a0724b8f1308dde8cd97d3c1f01b1eeeec92e7a36940aa14e2f05b");
    mtx.vin[0].prevout.n = 0;
    ...
    mtx.vin[0].scriptSig = CScript(vchScript.begin(), vchScript.end());
    mtx.vin[1].prevout.hash = uint256("2ca79a5fda3da844c3cebb809c599be248f2e0883d25d259fc408d95d7f769d6");
    mtx.vin[1].prevout.n = 0;
    ...
    mtx.vin[1].scriptSig = CScript(vchScript.begin(), vchScript.end());
    mtx.vin[2].prevout.hash = uint256("a4daaf4d6b63536fa4e046292337a5b72b37fd51f06c16689a22f5930daf78f8");
    mtx.vin[2].prevout.n = 0;
    ...
    mtx.vin[2].scriptSig = CScript(vchScript.begin(), vchScript.end());
    mtx.vin[3].prevout.hash = uint256("e2a1d7bf8c9b995f423f97887cd0bc6309e6d9d20faa94f8f2d79c8568b6f227");
    mtx.vin[3].prevout.n = 0;
    ...
    mtx.vin.resize(1);
    mtx.vin[0].prevout.hash = uint256("c4d3eb542503e05643cd16f68d750ba5e55c54108e253a37f98ecef1b2374583");
    mtx.vin[0].prevout.n = 0;
    ...
    mtx.vin.resize(1);
    mtx.vin[0].prevout.hash = uint256("e73ae02709850d51c538a8fd89013ee299d906d9f317fe7d30eff6e6c881ac43");
    mtx.vin[0].prevout.n = 0;
    ...
    mtx.vin.resize(2);
    mtx.vin[0].prevout.hash = uint256("f1e305f72f450a7d01af712e7c03fe0cc467059c00d2a8f4555cea017591cc48");
    mtx.vin[0].prevout.n = 0;
    ...
    mtx.vin[0].scriptSig = CScript(vchScript.begin(), vchScript.end());
    mtx.vin[1].prevout.hash = uint256("68d0685759c3d4f3f90a4f0e48d1b77641f06bb1f0b83a8841e8d71d5570ed41");
    mtx.vin[1].prevout.n = 0;
...
BOOST_AUTO_TEST_CASE(rolling_bloom)
{
    ...
    // Run test_zuzcoin with --log_level=message to see BOOST_TEST_MESSAGEs:

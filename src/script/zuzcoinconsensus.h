...
typedef enum zuzcoinconsensus_error_t
{
    zuzcoinconsensus_ERR_OK = 0,
    zuzcoinconsensus_ERR_TX_INDEX,
    zuzcoinconsensus_ERR_TX_SIZE_MISMATCH,
    zuzcoinconsensus_ERR_TX_DESERIALIZE,
    zuzcoinconsensus_ERR_AMOUNT_REQUIRED,
    zuzcoinconsensus_ERR_INVALID_FLAGS,
} zuzcoinconsensus_error;

/** Script verification flags */
enum
{
    zuzcoinconsensus_SCRIPT_FLAGS_VERIFY_NONE                = 0,
    zuzcoinconsensus_SCRIPT_FLAGS_VERIFY_P2SH                = (1U << 0), // evaluate P2SH (BIP16) subscripts
    zuzcoinconsensus_SCRIPT_FLAGS_VERIFY_DERSIG              = (1U << 2), // enforce strict DER (BIP66) compliance
    zuzcoinconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY           = (1U << 4), // enforce NULLDUMMY (BIP147)
...
EXPORT_SYMBOL int zuzcoinconsensus_verify_script(const unsigned char *scriptPubKey, unsigned int scriptPubKeyLen,
...
EXPORT_SYMBOL unsigned int zuzcoinconsensus_version();

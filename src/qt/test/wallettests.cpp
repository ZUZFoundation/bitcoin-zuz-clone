...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ZuzcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_zuzcoin-qt -platform xcb      # Linux
//     src/qt/test/test_zuzcoin-qt -platform windows  # Windows
//     src/qt/test/test_zuzcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = ZuzcoinUnits::formatWithUnit(unit, balance, false, ZuzcoinUnits::separatorAlways);
    ...
    // Amount input
    ZuzcoinAmountField* amountInput = receiveCoinsDialog.findChild<ZuzcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: zuzcoin:")) != -1);

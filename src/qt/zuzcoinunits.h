...
/** Zuzcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ZuzcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ZuzcoinUnits(QObject *parent);

    /** Zuzcoin units.
      @note Source: https://en.zuzcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ZUZ,
...
typedef ZuzcoinUnits::Unit ZuzcoinUnit;

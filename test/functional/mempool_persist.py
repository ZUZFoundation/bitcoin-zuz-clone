...
By default, zuzcoind will dump mempool on shutdown and
...
class MempoolPersistTest(ZuzcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give zuzcoind a second to reload the mempool
        ...
        self.log.debug("Prevent zuzcoind from writing mempool.dat to disk. Verify that `savemempool` fails")

...
class WalletTest(ZuzcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 10 ZUZ with subtract fee from amount
        ...
        # Sendmany 10 ZUZ with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/zuzcoin/zuzcoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6

...
# TestNode: A peer we use to send messages to zuzcoind, and store responses.
...
class CompactBlocksTest(ZuzcoinTestFramework):
    ...
    # This test actually causes zuzcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that zuzcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for zuzcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # zuzcoind will not send blocktxn responses for blocks whose height is

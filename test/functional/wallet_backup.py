...
class WalletBackupTest(ZuzcoinTestFramework):
    ...
    def run_test(self):
        ...
        fbalance0 = self.nodes[0].getbalance()
        fbalance1 = self.nodes[1].getbalance()
        fbalance2 = self.nodes[2].getbalance()
        fbalance3 = self.nodes[3].getbalance()

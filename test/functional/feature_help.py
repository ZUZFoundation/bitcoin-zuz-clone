#!/usr/bin/env python3
# Copyright (c) 2018 The Zuzcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting zuzcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import ZuzcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ZuzcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zuzcoin with -h for help text")
        ...
        self.log.info("Start zuzcoin with -version for version information")

Zuzcoin Core version 0.9.2.1 is now available from:

  https://zuzcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ZUZ to 0.01 ZUZ
...
- Fix "Start zuzcoin on system login"

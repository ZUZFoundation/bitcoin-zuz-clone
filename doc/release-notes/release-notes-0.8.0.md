Zuzcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/zuzcoin/files/Zuzcoin/zuzcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Zuzcoin
...
New/changed settings (command-line or zuzcoin.conf file)
--------------------------------------------------------

Zuzcoin Core version 0.9.4 is now available from:

  https://zuzcoin.org/bin/0.9.4/
...
this update is incompatible with the Zuzcoin system and could lead to consensus
forks.

Zuzcoin Core released binaries from https://zuzcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~zuzcoin/+archive/ubuntu/zuzcoin
- A third-party or self-compiled Zuzcoin Core

upgrade to Zuzcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

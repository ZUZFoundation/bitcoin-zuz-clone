Zuzcoin Core version 0.13.2 is now available from:

  <https://zuzcoin.org/bin/zuzcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update zuzcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow zuzcoin-tx to create v2 transactions (btcdrak)

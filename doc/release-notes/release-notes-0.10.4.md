Zuzcoin Core version 0.10.4 is now available from:

  <https://zuzcoin.org/bin/zuzcoin-core-0.10.4/>
...
- #6953 `43c2789` Split zuzcoin-tx into its own package
- #6953 `dfe0d4d` Include zuzcoin-tx binary on Debian/Ubuntu

...
* zuzcoin.conf: contains configuration settings for zuzcoind or zuzcoin-qt
* zuzcoind.pid: stores the process id of zuzcoind while running
...
* debug.log: contains debug information and general logging generated by zuzcoind or zuzcoin-qt

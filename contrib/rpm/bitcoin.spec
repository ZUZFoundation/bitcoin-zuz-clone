...
%{_sbindir}/semanage port -a -t zuzcoin_port_t -p tcp 4848
%{_sbindir}/semanage port -a -t zuzcoin_port_t -p tcp 18332
%{_sbindir}/semanage port -a -t zuzcoin_port_t -p tcp 14848
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 4848
	%{_sbindir}/semanage port -d -p tcp 18332
	%{_sbindir}/semanage port -d -p tcp 14848
